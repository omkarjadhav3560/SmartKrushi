...
<head>
  ...
  <title>Customer Registration - SmartKrushi</title>
  ...
  <style>
      .bg-register-cust {
          background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('../assets/img/market.jpg');
      ...
      .input-group:focus-within .input-group-text {
          border-color: #8ad4ee; /* Bootstrap default focus color or custom */
            ...
            <div class="col-lg-10">
                <div class="card card-register">
                    <div class="card-header bg-warning text-center py-4">
                        <h4 class="text-white mb-0"><i class="fas fa-shopping-basket"></i> Customer Registration</h4>
                        <p class="text-white-50 mb-0">Buy Fresh Crops Directly from Farmers</p>
                    </div>
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <form name="insert" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="name" placeholder="Ex: Anjali Sharma" required />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="email" name="email" placeholder="anjali@example.com" required />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <h6 class="heading-small text-muted mb-4 mt-4">Address Details</h6>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12"> <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="address" placeholder="House No, Street Name" required />
                                    </div>
                                </div>
                                </div>
                            ...
                            <div class="text-center mt-4">
                                <button type="submit" name="customerregister" class="btn btn-warning btn-lg px-5 text-white">Create Account</button>
                            </div>
                            
                            <div class="text-center mt-3">
                                <small>Already have an account? <a href="clogin.php" class="text-warning font-weight-bold">Login here</a></small>
                            </div>
                        </form>
                    </div>
                </div>
