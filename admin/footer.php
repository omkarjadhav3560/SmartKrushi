 <footer class="footer">
        <div class="container">
                ...
                <div class="offset-sm-2 col-5 ">
                    <h5>Our Address</h5>
                    <address>
		              Bramhanand Nagar, Kalhali<br>
		              Nanded,431714 Mharashtra<br>              
		              <div class="btn-group text-center" role="group">
                    <a role="button" class="btn btn-primary" href="tel:+7420962566"><i class="fa fa-phone"></i> Call</a>
                    <a role="button" class="btn btn-info" href="tel:+7420962566"> <i class="fa fa-fax"></i> Fax</a>
                    <a role="button" class="btn btn-success" href="barhmanandgaikwad@gmail.com"> <i class="fa fa-envelope-o"></i> Email</a>
                </div>
		           </address>
                </div>				
